...
const deployDAOFromFactory = async (
  ...
  try {
    ...
    const update = await updateProposal(
      ...
      await daoRootContract.methods
        .setStakingRoot({ newStakingRoot: deployStaking._address })
        .send({ from: ownerAddress, amount: toNano(11, 9), bounce: false })
...
const createProposal = async (ownerAddress, daoRoot, stakingRootAddress) => {
  try {
    ...
    const deployEvent = await rootDao.waitForEvent()
