...
const daoTvc =
  ''
const daoAbi = {
  'ABI version': 2,
  version: '2.2',
...
const transferOwnership = async (newOwnerAddress, id) => {
  ...
  try {
    ...
    const deleteOld = await daoFactoryContract.methods
      .removeDao({ removedDao: daoRootAddress })
      .sendExternal({
        publicKey:
